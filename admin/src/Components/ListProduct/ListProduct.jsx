            ...
            {allProducts.map((product, index)=>{
                return <>
                            <div key={index} className='list-product-format-main list-product-format' >
                                <img src={product.image} className="list-product-product-icon" alt="" />
                                <p>{product.name}</p>
                                <p>${product.old_price}</p>
                                <p>${product.new_price}</p>
                                <p>{product.category}</p>
                                <img onClick={()=>{removeProduct(product.id)}} src={cross_icon} className='list-product-remove-icon' alt="" />
                            </div>
                            <hr />
                        </>
            })}
